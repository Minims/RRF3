...
M915 p0 s20 H400 r0		; Configure stall detect in case we hit max endstops
M915 p1 s20 H400 r0		; Configure stall detect
...
M400					; Wait for stop
M915 p0 s20 H400 r0		; Configure stall detect
...
G4 P200
G1 H1 X-325 F2500		; Move towards endstop until it stalls
M915 p0 s20 H400 r0		; Configure stall detect to be less sensitive
M400
G4 P200
; y
...
G4 P200
G1 H1 Y-325 F2500		; Move towards endstop until it stalls
M915 p1 s20 H400 r0		; Configure stall detect to be less sensitive
G4 P200
; z
...
M915 p0 S20 H400 r2		; Configure stall detect to report stalls
M915 p1 S20 H400 r2		; on both X and Y
